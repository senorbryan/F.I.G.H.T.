...
class General:
    ...
    #Designates a win condition, augmenting the player's win count
    def win(self):
        print(self.name + " wins!")
        player.wins = player.wins + 1
    
    #The ultimate win condition that gets called once the player defeats 5 enemies
    def victory(self):
    ...
    #The loss condition that gets called once the player's HP reaches 0 or below
    def game_over(self):
